          ...
          <div className="skillset-parent">
            ...
            <div className="skillset-content">
                <ul className="primary-list">
                    ...
                    <li><h6>Photoshop/Illustrator</h6>
                        <div className="list-bar">
                    ...
                    <li><h6>React JS/React Native</h6>
                        <div className="list-bar">
                        <div className="skills react">75%</div>
                        </div>
                    </li>

                    <li><h6>Bootstrap/Git</h6>
                        <div className="list-bar">
                        <div className="skills bootstrap">65%</div>
                        </div>
                    </li>
                    <li><h6>Redux/REST API</h6>
                        <div className="list-bar">
                ...
                <ul className="secondary-list">
                    ...
                    <li><h6>VMWare/Cloud</h6>
                        <div className="list-bar">
                        <div className="skills vmwc">70%</div>
                        </div>
                    </li>
                    <li><h6>Troubleshooting/Repairs</h6>
                        <div className="list-bar">
                        <div className="skills trbsr">95%</div>
                        </div>
                    </li>
                    <li><h6>Networking (TCP/IP)</h6>
                        <div className="list-bar">
                        <div className="skills net">75%</div>
                        </div>
                    </li>
                    <li><h6>MS Products</h6>
                        <div className="list-bar">
                        <div className="skills ms">80%</div>
                        </div>
                    </li>
                    <li><h6>Customer Service/Admin</h6>
                        <div className="list-bar">
